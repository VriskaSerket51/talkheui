...
import { AheuiInterpreter } from "@/utils/aheui";
...
//     row_cnt: number,
//     col_cnt: number,
//     code: Operation[][] | undefined = undefined
//   ) {
//     this.row_cnt = row_cnt;
//     this.col_cnt = col_cnt;
//     if (code === undefined) {
//       this.code = [...Array(row_cnt)].map<Operation[]>((): Operation[] => {
//         return [...Array(row_cnt)].map<Operation>(
//           (): Operation => new Nothing()
//         );
//       });
//     } else {
//       this.code = code;
...
//     if (
//       row_idx >= 0 &&
//       row_idx < this.row_cnt &&
//       col_idx >= 0 &&
//       col_idx < this.col_cnt
//     ) {
...
//       .into();
//     if (
//       data.row_idx === data.cursor.row_idx &&
//       data.col_idx === data.cursor.col_idx
//     ) {
//       return (
//         <span className="cell cell-cursor" onClick={cellClickHandler}>
//           {str}
//         </span>
//       );
//     } else {
//       return (
//         <span className="cell" onClick={cellClickHandler}>
//           {str}
//         </span>
//       );
//     }
    ...
    <>
      ...
      >
        <button
          onClick={() => {
            setIsRunning(true);
            new AheuiInterpreter(inputRef.current!.value).run().then(() => {
              setIsRunning(false);
            });
          }}
          disabled={isRunning}
        ...
        <textarea ref={inputRef} disabled={isRunning} />
      </div>
    </>
  );
}
